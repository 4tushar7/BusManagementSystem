...
<html>
    <head>
        <title>Delete Schedule Form</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="main">
            ...
            <div class="center">
                ...
                <div class="div1"></div>
                <div class="div2"></div>
                <div class="div4"><a href="DeleteSchedule.jsp" ><button class="ab">Back</button></a></div>
                <div class="div3"><h3><a href="logout.jsp"><button class="ab">LOGOUT</button></a></h3></div>
           </div>
            <div class="box">
            <h1>Delete Schedule</h1>
	<form name="MyForm" action="DeleteScheduleServlet">
            <h4>Bus License:</h4><input type="text" name="BN" placeholder="Bus License" class="input">
        ...
        <h4>Date:</h4><input type="text" name="DT" placeholder="Route No" class="input"><br>
