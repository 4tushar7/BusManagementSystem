...
%>
    ...
    {
    %>
<%@page import="Model.AddDriver"%>
<%@page import="java.util.List"%>
<%@page import="Model.AddDriverDAO"%>
        ...
        <div class="main">
           ...
           <table class="tb">
                ...
                <th>Route Number</th>
                 ...
                 <%
                   AddDriverDAO obj=new AddDriverDAO();
                   List<AddDriver> l=obj.getDriver(); 
                    for(AddDriver i:l){
                        %>
                        <tr>      
                ...
                <a href="DeleteDriver.jsp" style="text-decoration:none;"><button class="btn">Delete</button></a>
            </div>
        </div>
           <div class="sub2"></div>
        </div>
