<%-- 
    Document   : DeleteBus
    Created on : Feb 24, 2019, 5:06:45 PM
    Author     : DELL
--%>
<%
...
<html>
        ...
        <div class="main">
            <div class="sub1"></div>
             <div class="center">
                ...
                <div class="div1"></div>
                <div class="div2"></div>
                <div class="div4"> <a href="DeleteBus1.jsp" ><button class="ab">Back</button></a></div>
                <div class="div3"><h3><a href="logout.jsp"><button class="ab">LOGOUT</button></a></h3></div>
           </div>
            <div class="box">
            <h1>Delete Bus</h1>
	<form name="MyForm" action="DeleteBusServlet">
	<h4>Bus No:</h4><input type="text" name="BN" placeholder="Bus no" class="input">
        ...
        <h4>Driver Contact:</h4><input type="text" name="DC" placeholder="Driver Contact" class="input"><br>
