...
public final class AddUserForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form name=\"MyForm\" action=\"AddUserServlet\">\n");
      out.write("\t<h4>Full Name:</h4><input type=\"text\" name=\"FN\" placeholder=\"Full Name\" class=\"input/\">\n");
      out.write("\t<h4>Student Id:</h4><input type=\"text\" name=\"ST\" placeholder=\"Student Id\" class=\"input\"/>\n");
      out.write("        <h4>Address:</h4><input type=\"text\" name=\"AD\" placeholder=\"Address\" class=\"input\"/>\n");
      out.write("        <h4>Stop:</h4><input type=\"text\" name=\"DT\" placeholder=\"Stop\" class=\"input\"/>\n");
      out.write("        <h4>Route Number:</h4><input type=\"text\" name=\"DT2\" placeholder=\"Route Number\" class=\"input\"/>\n");
      out.write("        <h4>Bus Number:</h4><input type=\"text\" name=\"DT3\" placeholder=\"Bus Number\" class=\"input\"/><br>\n");
